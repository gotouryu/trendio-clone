...
const dict: Record<Locale, Record<string, string>> = {
  ja: {
    ...
    "settings.toast.instagramConnected": "Instagramを接続しました",
    "settings.toast.tiktokConnected": "TikTokを接続しました",
    "settings.toast.companyUpdated": "会社情報を保存しました",
    "settings.toast.autoReplyRuleSaved": "自動応答ルールを保存しました",
    "settings.toast.autoReplyRuleSaveFail": "保存に失敗しました",
    "settings.toast.disconnectFail": "切断に失敗しました",
    "settings.toast.instagramDisconnected": "Instagramの接続を解除しました",
    "settings.toast.tiktokDisconnected": "TikTokの接続を解除しました",
    "settings.toast.themeChanged": "テーマを{label}に切り替えました",
    "settings.toast.langJa": "言語を日本語に切り替えました",
    "settings.toast.langEn": "Language switched to English",
    "settings.theme.label.light": "ライト",
    "settings.theme.label.dark": "ダーク",
    "settings.theme.label.system": "システム",
    "settings.oauth.err.metaNotConfigured": "Meta App が未設定です(.env の META_APP_ID 等を確認)",
    "settings.oauth.err.tiktokNotConfigured": "TikTok App が未設定です",
    "settings.oauth.err.stateMismatch": "セキュリティ検証に失敗しました。もう一度お試しください",
    "settings.oauth.err.tokenExchangeFailed": "トークン交換に失敗しました",
    "settings.oauth.err.noIgBusinessAccount":
      "InstagramビジネスアカウントがFacebookページに紐付いていません",
    "settings.oauth.err.dbUpsertFailed": "接続情報の保存に失敗しました",
    "settings.oauth.err.missingCode": "認可コードが返ってきませんでした",
    "settings.oauth.err.supabaseNotConfigured": "Supabase が未設定です",
    "settings.oauth.err.userMismatch":
      "ログインしているユーザーと OAuth フロー開始時のユーザーが異なります",
    "settings.oauth.err.unknown": "接続エラー(=詳細は管理者へ)",
    "comments.toast.replySent": "返信を送信しました",
    "comments.toast.archived": "アーカイブしました",
    "comments.toast.bulkArchived": "{n} 件をアーカイブしました",
    "comments.toast.aiGenerated": "AIが返信案を生成しました",
    "comments.toast.aiGeneratedFallback": "テンプレ応答を返しました(Claude APIキー未設定)",
    "comments.toast.aiFailed": "AI返信生成に失敗",
    "comments.toast.autoOn": "自動応答モードを ON にしました(無人受付開始)",
    "comments.toast.autoOff": "自動応答モードを OFF にしました",
    "comments.toast.toggleFail": "自動応答モードの切替に失敗しました",
    "ai.toast.alreadySaved": "既に保存されています",
    "ai.toast.saved": "保存しました",
  ...
  en: {
    ...
    "nav.aiContent": "AI Script Generator",
    ...
    "settings.toast.instagramConnected": "Instagram connected",
    "settings.toast.tiktokConnected": "TikTok connected",
    "settings.toast.companyUpdated": "Company info saved",
    "settings.toast.autoReplyRuleSaved": "Auto-reply rules saved",
    "settings.toast.autoReplyRuleSaveFail": "Failed to save",
    "settings.toast.disconnectFail": "Failed to disconnect",
    "settings.toast.instagramDisconnected": "Instagram disconnected",
    "settings.toast.tiktokDisconnected": "TikTok disconnected",
    "settings.toast.themeChanged": "Theme changed to {label}",
    "settings.toast.langJa": "言語を日本語に切り替えました",
    "settings.toast.langEn": "Language switched to English",
    "settings.theme.label.light": "Light",
    "settings.theme.label.dark": "Dark",
    "settings.theme.label.system": "System",
    "settings.oauth.err.metaNotConfigured":
      "Meta App is not configured (.env: META_APP_ID etc.)",
    "settings.oauth.err.tiktokNotConfigured": "TikTok App is not configured",
    "settings.oauth.err.stateMismatch":
      "Security verification failed. Please try again",
    "settings.oauth.err.tokenExchangeFailed": "Token exchange failed",
    "settings.oauth.err.noIgBusinessAccount":
      "Your Instagram Business Account is not linked to a Facebook Page",
    "settings.oauth.err.dbUpsertFailed": "Failed to save connection info",
    "settings.oauth.err.missingCode": "Authorization code was not returned",
    "settings.oauth.err.supabaseNotConfigured":
      "Supabase is not configured",
    "settings.oauth.err.userMismatch":
      "The signed-in user differs from the one who started the OAuth flow",
    "settings.oauth.err.unknown": "Connection error (=contact admin for details)",
    "comments.toast.replySent": "Reply sent",
    "comments.toast.archived": "Archived",
    "comments.toast.bulkArchived": "Archived {n} comments",
    "comments.toast.aiGenerated": "AI generated a reply draft",
    "comments.toast.aiGeneratedFallback":
      "Template reply returned (Claude API key not configured)",
    "comments.toast.aiFailed": "AI reply generation failed",
    "comments.toast.autoOn":
      "Auto-Reply Mode is ON (Unattended Reception started)",
    "comments.toast.autoOff": "Auto-Reply Mode is OFF",
    "comments.toast.toggleFail": "Failed to toggle Auto-Reply Mode",
    "ai.toast.alreadySaved": "Already saved",
