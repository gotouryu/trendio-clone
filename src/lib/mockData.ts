...
export const mockPlanIdeas: PlanIdea[] = [
  {
    id: "p1",
    angle: "トレンド型",
    title: "3秒で伝わる看板メニュー紹介",
    concept: "冒頭で一番見栄えする素材を見せ、今すぐ行きたい気持ちを作る王道型",
    hook: "これ、今日食べられるなら寄り道したくなりませんか?",
    outline: "1. 看板メニューのドアップ\n2. こだわり3点をテンポよく表示\n3. 来店案内とCTA",
    trendFit: "冒頭シズルと3選テロップの短尺投稿型に寄せる",
    buzzReason: "食欲を刺激する画で視聴維持、近隣ユーザーの保存を狙う",
    recommendedFor: "来店、認知、限定メニュー告知を強めたい時",
  },
  {
    id: "p2",
    angle: "バズ・共感型",
    title: "実は知らない裏側密着",
    concept: "普段見えない準備やこだわりを見せ、コメントしたくなる親近感を作る",
    hook: "開店前の30分、実はここまでやっています",
    outline: "1. 準備の意外な手間を見せる\n2. スタッフのこだわりを一言\n3. コメントや来店につなげる",
    trendFit: "裏側密着、職人の手元、意外な準備工程の型",
    buzzReason: "知らなかった反応と応援コメントが起きやすい",
    recommendedFor: "ファン化、親近感、スタッフの人柄を出したい時",
  },
  {
    id: "p3",
    angle: "保存型",
    title: "失敗しない選び方チェック",
    concept: "来店前や購入前の不安をチェックリスト化し、保存される実用性を作る",
    hook: "迷ったら、この3つだけ見てください",
    outline: "1. よくある失敗を提示\n2. 選び方の3項目を紹介\n3. 相談・予約CTA",
    trendFit: "3選、チェックリスト、失敗回避の保存型投稿",
    buzzReason: "後で見返す価値があり、保存とシェアを狙える",
    recommendedFor: "比較検討中の顧客、不安解消、保存数を狙う時",
  },
  {
    id: "p4",
    angle: "信頼型",
    title: "選ばれる理由を見える化",
    concept: "強みを押し売りせず、工程や判断基準を見せて納得感を作る",
    hook: "安さより先に、ここを見てほしいです",
    outline: "1. 顧客が迷うポイントを提示\n2. 店舗側の判断基準を見せる\n3. 安心して相談できるCTA",
    trendFit: "専門家目線、選び方解説、裏側公開の信頼型",
    buzzReason: "派手さより納得感で最後まで見られ、問い合わせ前の不安を減らす",
    recommendedFor: "高単価、予約制、専門性が選定理由になる商材",
  },
  {
    id: "p5",
    angle: "新規性型",
    title: "逆転発想の使い方提案",
    concept: "いつもの売り方から外し、意外な利用シーンで新しい欲求を作る",
    hook: "実は、これ目的で来る人も増えています",
    outline: "1. 意外な利用シーンを提示\n2. 実際の使い方を短く見せる\n3. 新しい目的での来店・相談CTA",
    trendFit: "意外な使い方、別用途提案、視点ずらしの型",
    buzzReason: "意外性で続きを見たくなり、コメントのきっかけも作れる",
    recommendedFor: "競合と似た訴求から抜けたい時、新しい客層に届けたい時",
  },
];
